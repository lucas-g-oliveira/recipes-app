...
describe('Testa o componente Recipes', () => {
  it('Verifica renderizacao dos filtros por categoria', async () => {
    ...
    await waitForElement(() => expect(screen.getByTestId('Beef-category-filter')).toBeInTheDocument());
  ...
  it('Verifica renderizacao dos filtros por categoria na pagina', async () => {
    // global.fetch = jest.fn(() => Promise.resolve({
    //   json: () => Promise.resolve(mealCategories),
    // }));
    /* await act(async () => { renderWithRouter(<App />); }); */
